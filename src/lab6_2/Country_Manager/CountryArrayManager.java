package lab6_2.Country_Manager;
...
public class CountryArrayManager {
    ...
    public Country[] sortByIncreasingPopulation() {
        ...
        for (int i = 0; i < newArray.length; i++) {
            int minPolulationIndex = i;
            for (int j = i; j < newArray.length; j++) {
                if (newArray[j].getPopulation() < newArray[minPolulationIndex].getPopulation()) {
                    minPolulationIndex = j;
                }
            }
            if (i != minPolulationIndex) {
                Country temp = newArray[i];
                newArray[i] = newArray[minPolulationIndex];
                newArray[minPolulationIndex] = temp;
            }
        }
    ...
    public AfricaCountry[] filterAfricaCountry() {
        ...
        for (int i = 0; i < this.countries.length; i++) {
            if (this.countries[i] instanceof AfricaCountry) {
                africaCountries[startIndex] = (AfricaCountry) this.countries[i];
                startIndex++;
            }
        }
    ...
    public Country[] filterMostPopulousCountries(int howMany) {
       Country[] mostPolulousCountry = sortByDecreasingPopulation();
       Country[] howManyCountries = new Country[howMany];
       System.arraycopy(mostPolulousCountry, 0, howManyCountries, 0, howMany);
